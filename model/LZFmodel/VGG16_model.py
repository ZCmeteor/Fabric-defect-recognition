...
class vgg16:
    ...
    def convlayers(self):
        # zero-mean input
        #conv1
        self.conv1_1 = self.conv("conv1re_1",self.imgs,64,trainable=False) #trainable=False=True
        ...
        #conv5
        self.conv5_1 = self.conv("conv5_1",self.pool4,64,trainable=True)
...
#        self.conv5_3 = self.conv("conv5_3",self.conv5_2,512,trainable=True)
        self.pool5 = self.maxpool("poorwel5",self.conv5_1,trainable=True)

    def fc_layers(self):

#        self.fc6 = self.fc("fc6", self.pool5, 4096,trainable=True)#trainable=False
        self.fc7 = self.fc("fc7", self.pool5, 2048,trainable=True)#trainable=False
